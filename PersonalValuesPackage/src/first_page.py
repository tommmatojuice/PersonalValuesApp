...
from PersonalValuesPackage.src.card import Card
from PersonalValuesPackage.src.cards_list_view import CardsListView
from PersonalValuesPackage.src.instruction_1 import Instruction1
...
class FirstPage(PageWindow):
    ...
    def next_page(self):
        ...
        self.parent.register(SecondPage(cards_list, self.parent), "second_new")
