...
from PersonalValuesPackage.src.instruction_3 import Instruction3
...
class ThirdPage(PageWindow):
    ...
    def prev_page(self):
        ...
        :return: None
        """
        from PersonalValuesPackage.src.second_page import SecondPage
        self.parent.register(SecondPage(self.cards_list_copy, self.parent), "second_new")
    ...
    def next_page(self):
        ...
        from PersonalValuesPackage.src.fourth_page import FourthPage
