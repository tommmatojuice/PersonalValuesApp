...
class Instruction2(QMainWindow):
    """
    ...
    def __init__(self, parent=None):
        ...
        """
        super(Instruction2, self).__init__(parent)
        self.resize(866, 603)
    ...
    def retranslate_ui(self):
        ...
        self.text.setText(_translate("MainWindow", "In this step, you will only be working with the \n"
                                                   ...
                                                   "asked to do one other small task."))
